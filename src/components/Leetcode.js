    ...
    <div className="background__section">
      ...
      <div className="sub_navbar">
        ...
        <div className="sub_navbar_heading">
          <h1 className="section__title">Leetcode</h1>
          <span className="section__subtitle">
            Leetcoding problems help you think about problems with a tool belt,
            instead of using one tool to approach a variety of problems.
          </span>
        </div>
